  ...
  const steps = [
    {
      number: "01",
      title: "Liều Lượng",
      description: "Uống 1–2 viên/ngày trước khi chạy bộ hoặc tập luyện, tốt nhất vào buổi sáng để tận dụng tối đa năng lượng.",
      icon: (
    ...
    },
    {
      number: "02", 
      title: "Cách Dùng",
      description: "Uống cùng nước ấm để tăng hiệu quả hấp thụ và kích hoạt các hoạt chất. Tránh dùng cùng cà phê hoặc đồ uống có cồn.",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      number: "03",
      title: "Thời Điểm",
      description: "Sử dụng 30 phút trước hoạt động thể chất hoặc khi cần tăng năng lượng và sự tập trung cho công việc.",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      number: "04",
      title: "Lưu Ý",
      description: "Bảo quản nơi khô ráo, tránh ánh nắng trực tiếp. Tham khảo ý kiến bác sĩ nếu có bệnh lý đặc biệt hoặc đang dùng thuốc.",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <section className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-20 left-10 w-40 h-40 parallax-slow">
          <svg viewBox="0 0 100 100" className="w-full h-full text-emerald animate-float">
        ...
        <div className="absolute bottom-20 right-10 w-32 h-32 parallax-slow">
          <svg viewBox="0 0 100 100" className="w-full h-full text-secondary animate-float animate-delay-300">
            <circle cx="50" cy="50" r="30" fill="none" stroke="currentColor" strokeWidth="3" />
            <path d="M35 50 L45 40 L65 60" stroke="currentColor" strokeWidth="3" fill="none" />
          </svg>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid gap-8">
            {steps.map((step, index) => (
              <div 
                key={index}
                className={`group animate-fade-up animate-delay-${(index + 1) * 100}`}
              >
