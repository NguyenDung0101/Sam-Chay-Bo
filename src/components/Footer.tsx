        ...
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6 animate-fade-up">
            ...
            <p className="font-montserrat text-ivory/80 leading-relaxed">
              Sản phẩm nhân sâm cao cấp Việt Nam, mang lại năng lượng và sức
              khỏe bền vững cho cuộc sống năng động của bạn.
            </p>
          ...
          <div className="space-y-6 animate-fade-up animate-delay-200">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="font-montserrat text-ivory/80">
                  info@samchaybo.vn
                </span>
              </div>
        ...
        <div className="border-t border-secondary/30 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              <a
                href="#"
                className="font-montserrat text-ivory/60 hover:text-secondary text-sm transition-colors duration-300"
              >
                Chính Sách Bảo Mật
              </a>
              <a
